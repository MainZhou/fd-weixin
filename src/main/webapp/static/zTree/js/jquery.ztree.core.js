...
(function($){
	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			var style="";
			if(name.length>10){
				style="style='display:inline-block;line-height:15px;text-overflow:ellipsis;overflow:hidden;width:140px;'";
			}
		...
		makeDOMNodeMainBefore: function(html, setting, node) {
			...
			//}
			html.push("<li id='", node.tId, "' class='", consts.className.LEVEL, node.level,"' ",style," tabindex='0' hidefocus='true' treenode>");
			style="";
		},
