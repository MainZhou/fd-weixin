...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-md-12 sidebar-offcanvas">
            ...
            <form:form action="${ctx}/module/update" commandName="update" method="post">
                ...
                <div class="form-group">
                    ...
                    <form:select path="menu.guid" cssClass="form-control" id="parentMenu">
                        <form:option value="" label="--请选择--"/>
                        <form:options items="${childMenuList}" itemLabel="menuName" itemValue="guid"/>
                    </form:select>
                </div>
                <div class="form-group">
