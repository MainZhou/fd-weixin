...
<div class="top">
    <div class="am-g am-g-collapse" style="margin: auto">
        <div class="am-u-sm-2">
            <a href="${ctx}/batchMakeup/list"><span class="am-icon-angle-left am-icon-lg"
...
<div class="am-g am-g-collapse" style="margin-top: 5%">
    ...
    <div class="am-u-sm-3 am-u-sm-offset-1">
        <span style="float: right;margin-top: 3px">进货时间：</span>
    </div>
...
<script type="text/javascript" src="${ctx}/grid/batchPhoto.js"></script>