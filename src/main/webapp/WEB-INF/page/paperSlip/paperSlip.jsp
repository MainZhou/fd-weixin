        ...
        <div class="weui_tab">
            <div class="weui_tab_bd">
                ...
                <c:if test="${lists != null}">
                    <div class="scroll"
                         style="border-top: 1px solid silver;width:100%;position: absolute;overflow:scroll;-webkit-overflow-scrolling: touch;top:220px;bottom: 150px;overflow-x: hidden;"
                         id="table1">
                        <c:forEach items="${lists}" var="photo" varStatus="status">
                            <a href="${ctx}/paperSlip/photographUI?imgId=${photo.img}&index=${status.index}">
                                <div class="weui_panel_bd">
                                    ...
                                    <span class="weui_media_desc"
                                          style="font-size: 15px;color: black">成都市食用农产品交易凭证</span>
                                        <span class="weui_media_desc"
                                              style="font-size: 15px;color: black;margin-top: 5px;">时间：${photo.time}</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                ...
                <c:if test="${lists != null }">
                    <button class="am-btn  am-round loginBut"
                            style="width:80%;outline:none;color: white;margin-left: 10%;position: absolute;bottom: 100px;"
                            id="save">
                        保存
                    </button>
                </c:if>
...
<script type="text/javascript" src="${ctx}/grid/paperSlip.js"></script>