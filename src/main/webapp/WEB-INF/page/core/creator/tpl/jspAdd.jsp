...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-md-12 sidebar-offcanvas">
            ...
            <form:form action="<c:out value='\${ctx}'/>/${columnRequest.prefixFirstCharLow}/add" commandName="${columnRequest.prefixFirstCharLow}" method="post">
                ...
                <div class="form-group">
                    ...
                    <c:choose>
                        <c:when test="${item.value.inputType == '日期'}">
                            <form:input path="${item.value.javaName}" cssClass="form-control" onClick="WdatePicker()" />
                </c:when>
