        ...
        <div class="weui_cells weui_cells_form" style="font-size: 15px">
            <div class="weui_cell">
                ...
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" placeholder="请输入市场名称（可简写）" name="wholesalerName">
                </div>
            ...
            <div class="weui_cell ">
                ...
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" placeholder="请输入社会信用代码" name="socialCreditCode">
                </div>
                <div class="weui_cell_ft">
                    <i class="weui_icon_warn"></i>
                </div>
            ...
            <div class="weui_cell">
                <div class="weui_cell_hd"><label class="weui_label">企业住所地址</label></div>
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" placeholder="请输入企业住所地址" name="address">
                </div>
                <div class="weui_cell_ft">
                    <i class="weui_icon_warn"></i>
                </div>
            ...
            <div class="weui_cell">
                <div class="weui_cell_hd"><label class="weui_label">法&emsp;人</label></div>
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" placeholder="请输入企业法人姓名" name="legal">
                </div>
                <div class="weui_cell_ft">
                    <i class="weui_icon_warn"></i>
                </div>
            ...
            <div class="weui_cell">
                <div class="weui_cell_hd"><label class="weui_label">法人手机号</label></div>
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" placeholder="请输入企业法人联系方式" name="mobile">
                </div>
                <div class="weui_cell_ft">
                    <i class="weui_icon_warn"></i>
                </div>
            ...
            <div class="weui_cell">
                <div class="weui_cell_hd"><label class="weui_label">法人身份证号</label></div>
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" maxlength="" pattern="[0-9]*" placeholder="请输入企业法人身份证号" name="cardNo">
                </div>
                <div class="weui_cell_ft">
                    <i class="weui_icon_warn"></i>
                </div>
            ...
            <div class="weui_cell weui_cell_select">
                ...
                <div class="weui_cell_bd weui_cell_primary">
                    <select class="weui_select" name="wmid">
                        ...
                        <c:forEach var="item" items="${jsonObject.wnInfo}">
            ...
            <ul data-am-widget="gallery" class="am-gallery am-avg-sm-3 am-avg-md-3 am-avg-md-3 am-gallery-default">
                <li>
                    <div class="am-gallery-item">
                        <a href="#" class="" id="enterpriseId">
                            <img src="${ctx}/static/img/pic.png" alt="社会信用代码" style="height: 80px" id="enterpriseIdImg"/>
                            <h3 class="am-gallery-title" style="text-align: center">社会信用代码</h3>
                            <input type="hidden" id="enterpriseFromWx" name="enterpriseFromWx">
                        </a>
                    </div>
                </li>
                <li>
                    <div class="am-gallery-item">
                        <a href="#" class="" id="idPhoto1">
                            <img src="${ctx}/static/img/pic.png" alt="身份证正面" id="idPhoto1Img" style="height: 80px"/>
                ...
                <li>
                    <div class="am-gallery-item">
                        <a href="#" class=""  id="idPhoto2">
                            <img src="${ctx}/static/img/pic.png" alt="身份证反面" id="idPhoto2Img" style="height: 80px"/>
