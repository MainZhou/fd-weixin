        ...
        <div class="weui_tab">
                ...
                <div class="scroll"
                    ...
                    <div class="am-scrollable-horizontal" style="background-color: white">
                        <div style="text-align: right;margin-right: 20px;margin-top: 10px;background-color: white">
                            <div style="display: none;padding-left: 15px;color: #efad4c;float: left" id="fillInfo">
                                <a href="${ctx}/wxFillInfo">请在3日内完善个人信息</a>
                            </div>
            ...
            <div class="weui_tabbar">
                <a href="${ctx}/makeup/list?index=0&checkIndex=0" class="weui_tabbar_item" style="text-decoration:none;">
                    ...
                    <p class="weui_tabbar_label">进货申报</p>
                </a>
...
<script>
    $(function(){
        $.get("${ctx}/checkFill", function(data){
            // 批发市场经营户, 返回的data为空
            if(data && data.result == "1" && 0 == data.data.length){
