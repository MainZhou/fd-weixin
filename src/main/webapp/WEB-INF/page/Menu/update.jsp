...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-md-12 sidebar-offcanvas">
            ...
            <form:form action="${ctx}/menu/update" commandName="update" method="post">
                ...
                <div class="form-group">
                    <label><spring:message code='Menu.parentId.label' /></label> <span class="msg-box" for="parentMenu.guid"></span>
                ...
                <div class="form-group">
                    ...
                    <c:forEach items="${icons}" var="item">
                        <label class="checkbox-inline">
                            <c:choose>
                                <c:when test="${update.icon.guid == item.guid}">
                                    <input type="radio" name="icon.guid" checked value="${item.guid}"> <span class="${item.cssName}"></span>
                                </c:when>
                                <c:otherwise>
                                    <input type="radio" name="icon.guid" value="${item.guid}"> <span class="${item.cssName}"></span>
                                </c:otherwise>
                            </c:choose>
                        </label>
                    </c:forEach>
